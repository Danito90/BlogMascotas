...
class Mascota(models.Model):
    id_autor = models.ForeignKey(Autor, on_delete=models.CASCADE, blank=True, null=True)
    tipo = models.CharField(max_length=50, choices=[('Perro', 'Perro'), ('Gato', 'Gato'),], default='Perro')
    nombreMascota = models.CharField(max_length=80)
    razaPerro = models.CharField(max_length=80, choices=RAZAPERROS, default='Seleccionar')
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['id_autor', 'nombreMascota','edad'], name='Mascota unica')
